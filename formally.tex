...
The approach that we take leaves the system unchanged. Instead, we define predicates over \emph{derivations} of the expression action judgements that excludes those derivations that apply subsumption prematurely, i.e. when another rule could have been applied. We call such derivations \emph{subsumption-minimal derivations}. We can establish determinism for subsumption-minimal derivations.
