...
\newcommand{\cvert}{{\hspace{1.8px}{\vert}\hspace{1.8px}}}
\begin{figure}[t]
...
Similarly, we write $\removeSel{\zexp}$ for the H-expression constructed by erasing the cursor from the Z-expression $\zexp$, i.e. the \emph{cursor erasure} of $\zexp$. The definition of this metafunction is analogous, so we omit it for concision (see supplement.)
% \begin{align*}
