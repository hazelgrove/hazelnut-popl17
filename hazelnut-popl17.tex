...
During these sequences of edit actions, or when the programmer makes a mistake, programmers and programming tools must contend with malformed text or semantically ill-defined programs.
...
2) a \emph{focus model}; and 3) a bidirectional \emph{action model} equipped with a useful \emph{action sensibility} theorem.
\end{abstract}
