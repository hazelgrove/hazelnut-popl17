...
every action in such a list, we couldn't hope to construct an ill-typed
term, so the statement here matches the mutually recursive structure of the
...
produce any well-typed expression.
