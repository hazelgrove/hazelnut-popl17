...
}
{
 ...
 \and
 $^3$~University of Colorado Boulder (USA)\vspace{-10px}
}
{
...
discuss how Hazelnut's semantics lends itself to implementation as an event-based functional reactive program. Our simple reference implementation is written in OCaml and compiled using \lstinline{js_of_ocaml}.
